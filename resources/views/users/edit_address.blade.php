        ...
        <div class="col-md-5">
            ...
            <form method="POST" action="/users/mypage">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-7">
                        <input type="name" type="text" class="form-control @error('name')is-invalid @enderror samazon-login-input" name="name" value="{{ $user->name }}" required autocomplete="name" autofocus placeholder="侍 太郎">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-7">
                        <input type="text" class="form-control @error('postal_code')id-invalid @enderror samazon-login-input" name="postal_code" value="{{ $user->postal_code }}" required placeholder="150-0043">
                    </div>
                </div>
